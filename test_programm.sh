    ...
    do
        ...
        then
            ...
            then
                ...
                speed_up=$(echo "100 * (${reference_times[$iterator_values-1]}-milliseconds) / ${reference_times[$iterator_values-1]} + (1000 * (${reference_times[$iterator_values-1]}-milliseconds) / ${reference_times[$iterator_values-1]}" | bc) % 10 >= 5 ? 1 : 0)
            fi
